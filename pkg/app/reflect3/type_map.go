...
func TypeByName(typeName string) reflect2.Type {
	initOnce.Do(discoverTypes)
	return reflect2.Type2(types[typeName])
}

// TypeByPackageName return the type by its package and name
func TypeByPackageName(pkgPath string, name string) reflect2.Type {
	initOnce.Do(discoverTypes)
	pkgTypes := packages[pkgPath]
	if pkgTypes == nil {
		return nil
	}
	return reflect2.Type2(pkgTypes[name])
}
